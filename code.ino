...
{ 
  ...
  myservo3.writeMicroseconds(800); // pen up      // w/o these lines the servoos go crazy at the beginning
...
/*
  myservo3.writeMicroseconds(800); // pen up      // h
